...
export default function ProjectForm({ 
  ...
  const handleInputChange = (field: keyof SimplifiedProjectFormData, value: any) => {
  ...
  return (
    <div className=" py-8 px-4 ">
        <div className="bg-white rounded-2xl border border-gray-200/60 shadow-xl shadow-blue-100/50 backdrop-blur-sm ">
          <form onSubmit={handleSubmit} className="p-8 space-y-8 overflow-y-auto h-full">
            ...
            <div className="group">
              ...
              />
              {autoGeneratedProjectName && projectName !== autoGeneratedProjectName && (
                <button
                  type="button"
            ...
            <div className="group">
              <label className="flex items-center text-sm font-semibold text-gray-800 mb-3">
                ...
                Project Type <span className="text-gray-500 font-normal">(Optional)</span>
              </label>
              <select
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-gray-200/60">
            ...
            <p className="text-sm text-gray-600 font-medium">
              Details like budget, timeline, and agreements can be added later when creating estimates
            </p>
          </div>
        </div>
    </div>
